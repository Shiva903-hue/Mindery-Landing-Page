...
//             <div
//               key={plan.name}
//               className={`rounded-2xl border shadow-md p-6 flex flex-col justify-between hover:shadow-lg transition ${
//                 plan.highlight ? "border-purple-600 scale-105" : "border-gray-200"
//               }`}
//             >
//               <div>
...
//                       <span className="text-purple-600 mr-2">✔</span> {f}
//                     </li>
//                   ))}
//                 </ul>
//               </div>
