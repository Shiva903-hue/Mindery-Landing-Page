...
//             <li>✔ Mindfulness tips for parents</li>
//             <li>✔ Classroom activities for teachers</li>
//             <li>✔ Guides for managing stress at home</li>
//             <li>✔ Progress tracking for families</li>
//           </ul>

//           <button  className="bg-[#b12aff] hover:bg-purple-700 px-6 py-3 rounded-lg font-medium text-white transform transition-all duration-300 5 hover:shadow-lg  relative overflow-hidden group"
//             >
...
//         {/* Right Image */}
//         <div className="relative w-full h-72 lg:h-96 bg-gray-200 rounded-xl flex items-center justify-center shadow-inner">
//           <span className="text-gray-400">[ Hub Illustration ]</span>
//         </div>
//       </div>
//     </section>
//   );
