...
//             <span className="flex items-center">Mindery</span>
//           </div>

//           {/* Desktop Menu */}
//           <div className="hidden md:flex space-x-8">
//             {["Why", "Program", "Pricing", "Reviews", "FAQ"].map((item) => {
//               return (
//                 <a
//                   key={item}
//                   href="#why"
//                   className="text-purple-700 hover:text-green-600 font-bold transition"
//                 >
//                   {item}
//                 </a>
//               );
...
//                 key={item}
//                 href="#why"
//                 className="block text-gray-700 font-bold hover:text-green-600 transition"
//               >
//                 {item}
//               </a>
//             );
...
//           <button
//             onClick={onStartTrial}
//             className="w-full bg-purple-600 text-white px-4 py-2 rounded-lg shadow hover:bg-purple-700 transition"
//           >
//             Start Free Trial
//           </button>
//         </div>
