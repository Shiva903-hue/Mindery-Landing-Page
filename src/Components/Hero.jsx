...
//               <div key={card.item1} className="w-50 h-30 bg-white rounded-2xl shadow-md p-4 flex flex-col gap-1">
...
//                   <p className="text-gray-800 font-medium text-sm">{card.item2}</p>
//                   <p className="text-gray-800 font-bold text-xl">{card.item1}</p>
//                 </div>
//               </div>
//             ))}
//           </div>
...
//             <button
//               onClick={onOpenForm}
//               className="bg-[#b12aff] hover:bg-purple-700 px-6 py-3 rounded-lg font-medium text-white"
//             >
//               Start Free Trial
//             </button>
...
//         {/* Right Image */}
//         <div className="relative w-full h-72 lg:h-96 bg-gray-100 rounded-xl flex items-center justify-center shadow-inner">
